...
import FormFieldShop from './components/FormFieldShop';

function AddOfferType({ isOpen, onClose }) {
  ...
  const formFieldName = "Add your Offer Type";
  const registerName = "offer_type";
