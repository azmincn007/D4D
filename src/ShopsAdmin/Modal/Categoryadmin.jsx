...
function CategoryAdmin({ isOpen, onClose, onCategoryAdded, categoryToEdit }) {
  ...
  const [isEditMode] = useState(categoryToEdit);
        ...
        <Modal.Body>
          <div className="my-4">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <FormFieldCategory language="eng" register={register} errors={errors} isEditMode={isEditMode} value={categoryToEdit?.cat_eng} />
              <FormFieldCategory language="ar" register={register} errors={errors} isEditMode={isEditMode} value={categoryToEdit?.cat_ar} />
              <FormFieldCategory language="mal" register={register} errors={errors} isEditMode={isEditMode} value={categoryToEdit?.cat_mal} />
              <FormFieldCategory language="hin" register={register} errors={errors} isEditMode={isEditMode} value={categoryToEdit?.cat_hin} />
              <div className="mt-8 w-[50%] mx-auto">
                <Button type="submit" className="w-full py-2 bg-yellow text-black rounded" disabled={addOrUpdateCategoryMutation.isLoading}>
